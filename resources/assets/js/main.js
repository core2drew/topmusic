$(function() {
        ...
        $.ajax({
          ...
          error: function(data) {
            ...
            notif
              .find(".content")
              .text(
                "Something went wrong. Please try again or message us directly to info@topmusicmanagement.com"
              );
            notif
              .addClass("showing")
  ...
  function infoInit() {
    let info = $("#Info");
    let show = info.find(".show");
    let close = info.find(".close");
    let notif = info.find(".notification");
